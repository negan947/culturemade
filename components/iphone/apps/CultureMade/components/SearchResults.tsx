          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`p-2 rounded-lg transition-colors ${
                showFilters 
                  ? 'bg-purple-100 text-admin-accent' 
          ...
          {loading && results.length === 0 ? (
            ...
            >
              <div className="text-center max-w-sm">
                ...
                <button
                  onClick={handleRetry}
                  className="inline-flex items-center px-4 py-2 bg-admin-accent text-white rounded-lg hover:bg-admin-accent-hover transition-colors"
                >
