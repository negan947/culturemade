    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          <motion.div
            className="absolute inset-x-0 bottom-0 z-50 bg-gray-900 rounded-t-3xl shadow-2xl max-h-[90vh] overflow-hidden"
            initial={{ y: '100%' }}
            animate={{ y: 0 }}
            exit={{ y: '100%' }}
          ...
          >
            ...
            <div className="p-4 border-b border-gray-700 flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-400">Step {step === 'address' ? '1' : step === 'payment' ? '2' : '3'} of 3</p>
              </div>
              {step === 'confirm' ? (
                <div className="w-9" />
              ) : (
