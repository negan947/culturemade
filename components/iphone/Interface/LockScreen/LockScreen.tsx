...
import React, { FC, useEffect, useState, useCallback, useMemo, useRef, startTransition } from "react";
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-3 gap-x-8 gap-y-5 max-w-sm mx-auto mb-8">
        {keypadData.map(({ digit, letters }) => (
          <button
            ...
            className="relative w-20 h-20 rounded-full border border-white/30 bg-white/10 flex flex-col items-center justify-center text-white"
            style={{ contain: 'layout style paint' }}
          >
            <span className="text-3xl font-light leading-none pointer-events-none">{digit}</span>
            {letters && (
        ...
        <button
          ...
          className="relative w-20 h-20 rounded-full border border-white/30 bg-white/10 flex items-center justify-center text-white"
          style={{ contain: 'layout style paint' }}
        >
      ...
      <div className="flex justify-between items-center px-6 pb-12">
        <button className="text-white text-base ios-medium opacity-90">
          Emergency
        </button>
        <button onClick={onCancel} className="text-white text-base ios-medium opacity-90">
          Cancel
        </button>
      </div>
    </div>
