  ...
  return (
    <div className="container mx-auto p-8">
      ...
      <div className="p-6 bg-green-50 border border-green-200 rounded-lg">
        <h2 className="text-xl font-semibold text-green-800 mb-2">✅ Customer Access Successful</h2>
        <p className="text-green-700 mb-4">
          You have successfully accessed the customer account test page. This confirms that:
        </p>
      ...
      {profile?.role === 'admin' && (
        <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
          <h3 className="font-semibold text-yellow-800 mb-2">⚠️ Admin Notice</h3>
          <p className="text-yellow-700">
            You are logged in as an admin but accessing a customer route. 
            Admins can access all customer routes but customers cannot access admin routes.
          </p>
        </div>
      )}
