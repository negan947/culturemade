...
async function getDashboardStats(): Promise<DashboardStats> {
  ...
  const activeProducts = productStats?.filter(p => p.status === 'active').length || 0
  ...
  const lowStockProducts = new Set(lowStockData?.map(v => v.product_id) || []).size
  ...
  const alertCards = [
    {
      ...
      icon: AlertCircle,
      color: stats.lowStockProducts > 0 ? 'bg-admin-error' : 'bg-admin-text-disabled',
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {statCards.map((stat) => {
          ...
          return (
            <div key={stat.title} className="bg-admin-light-bg-surface dark:bg-admin-bg-surface rounded-lg shadow-admin-soft border border-admin-light-border dark:border-admin-border p-6 hover:shadow-admin-popover transition-shadow duration-200">
              <div className="flex items-center justify-between">
                ...
                <div className={`p-3 rounded-full ${stat.color} shadow-admin-soft`}>
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className={`p-3 rounded-full ${alert.color} shadow-admin-soft`}>
                  <Icon className="h-6 w-6 text-white" />
                </div>
              </div>
            </div>
      ...
      {/* Quick Actions */}
      <div className="bg-admin-light-bg-surface dark:bg-admin-bg-surface rounded-lg shadow-admin-soft border border-admin-light-border dark:border-admin-border p-6">
        <h2 className="text-lg font-semibold text-admin-light-text-primary dark:text-admin-text-primary mb-4">Quick Actions</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <div>
              <p className="font-medium text-admin-light-text-primary dark:text-admin-text-primary">Add New Product</p>
              <p className="text-sm text-admin-light-text-secondary dark:text-admin-text-secondary">Create a new product listing</p>
            </div>
          </a>
          ...
          >
            ...
            <div>
              <p className="font-medium text-admin-light-text-primary dark:text-admin-text-primary">View Orders</p>
              <p className="text-sm text-admin-light-text-secondary dark:text-admin-text-secondary">Manage customer orders</p>
            </div>
          </a>
          ...
          >
            ...
            <div>
              <p className="font-medium text-admin-light-text-primary dark:text-admin-text-primary">View Analytics</p>
              <p className="text-sm text-admin-light-text-secondary dark:text-admin-text-secondary">Check sales performance</p>
            </div>
          </a>
        </div>
      </div>
      ...
      {/* System Status */}
      <div className="bg-admin-light-bg-surface dark:bg-admin-bg-surface rounded-lg shadow-admin-soft border border-admin-light-border dark:border-admin-border p-6">
        <h2 className="text-lg font-semibold text-admin-light-text-primary dark:text-admin-text-primary mb-4">System Status</h2>
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <span className="text-sm text-admin-light-text-secondary dark:text-admin-text-secondary">Database Connection</span>
          ...
          <div className="flex items-center justify-between">
            <span className="text-sm text-admin-light-text-secondary dark:text-admin-text-secondary">Payment System</span>
            <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 dark:bg-admin-success/20 text-green-800 dark:text-admin-success border border-green-200 dark:border-admin-success/30">
              Operational
            </span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-sm text-admin-light-text-secondary dark:text-admin-text-secondary">Image Storage</span>
            <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 dark:bg-admin-success/20 text-green-800 dark:text-admin-success border border-green-200 dark:border-admin-success/30">
              Operational
            </span>
          </div>
