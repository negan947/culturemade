      ...
      <div className="container mx-auto p-8">
        ...
        <div className="space-y-6">
          <div className="p-4 bg-green-100 border border-green-300 rounded-lg">
            <h2 className="text-xl font-semibold text-green-800 mb-2">✅ Connection Status</h2>
            <p className="text-green-700">Database connection successful!</p>
          </div>

          <div className="p-4 bg-blue-100 border border-blue-300 rounded-lg">
            <h2 className="text-xl font-semibold text-blue-800 mb-2">📊 Database Tables</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <h3 className="font-semibold text-blue-700">Products Table</h3>
                <p className="text-blue-600">
                  {productsError ? `Error: ${productsError.message}` : `Found ${products?.length || 0} products`}
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-blue-700">Categories Table</h3>
                <p className="text-blue-600">
                  {categoriesError ? `Error: ${categoriesError.message}` : `Found ${categories?.length || 0} categories`}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 bg-purple-100 border border-purple-300 rounded-lg">
            <h2 className="text-xl font-semibold text-purple-800 mb-2">🔧 TypeScript Types</h2>
            <p className="text-purple-700">Database types successfully generated and imported</p>
          ...
          <div className="p-4 bg-gray-100 border border-gray-300 rounded-lg">
            <h2 className="text-xl font-semibold text-gray-800 mb-2">📋 Tables Summary</h2>
